									...
									<div class="card-body">
										...
										<form action="" method="post" enctype="multipart/form-data">
											...
											<div class="form-group row">
												<label for="keluar" class="col-sm-3 col-form-label">Tanggal Mutasi Keluar</label>
												<input class="col-sm-2 form-control <?php echo form_error('tgl_keluar') ? 'is-invalid' : '' ?>" type="date" id="keluar" name="tgl_keluar" placeholder="Tanggal Mutasi Keluar" value="<?php echo $penduduks->tgl_keluar ?>" />
											...
											<div class="form-group row">
												...
												<input class="col-sm-9 form-control <?php echo form_error('no_kk') ? 'is-invalid' : '' ?>" type="number" id="KK" name="no_kk" placeholder="Nomor Kartu Keluarga" value="<?php echo $penduduks->no_kk ?>" />
												<div class="invalid-feedback">
											...
											<div class="form-group row">
												...
												<input class="col-sm-9 form-control <?php echo form_error('nik') ? 'is-invalid' : '' ?>" type="number" id="nik" name="nik" min="0" placeholder="Nomor Induk Kependudukan" value="<?php echo $penduduks->nik ?>" />
												<div class="invalid-feedback">
											...
											<div class="form-group row">
												...
												<input class="col-sm-9 form-control <?php echo form_error('nama_lengkap') ? 'is-invalid' : '' ?>" type="text" id="nama" name="nama_lengkap" placeholder="Nama Lengkap" value="<?php echo $penduduks->nama_lengkap ?>" />
												<div class="invalid-feedback">
											...
											<div class="form-group row">
												...
												<input id="tempat" class="col-sm form-control <?php echo form_error('tempat_lahir') ? 'is-invalid' : '' ?>" type="text" name="tempat_lahir" placeholder="Tempat Lahir" value="<?php echo $penduduks->tempat_lahir ?>" />
												<h3> / </h3>
												<input id="tempat" class="col-sm-3 form-control <?php echo form_error('tgl_lahir') ? 'is-invalid' : '' ?>" type="date" name="tgl_lahir" placeholder="Tanggal Lahir" value="<?php echo $penduduks->tgl_lahir ?>" />
											</div>
											...
											<div class="form-group row">
												...
												<div class="form-check form-check-inline <?php echo form_error('alamat') ? 'is-invalid' : '' ?>">
													<label class="form-check-label" for="Laki-laki">
														<input class="form-check-input" type="radio" name="jenis_kelamin" id="Laki-laki" value="LAKI-LAKI" <?php if ($penduduks->jenis_kelamin == 'LAKI-LAKI') echo 'checked' ?>>LAKI-LAKI</label>
												</div>
												<div class="form-check form-check-inline">
													<label class="form-check-label" for="Perempuan">
														<input class="form-check-input" type="radio" name="jenis_kelamin" id="Perempuan" value="PEREMPUAN" <?php if ($penduduks->jenis_kelamin == 'PEREMPUAN') echo 'checked' ?>>PEREMPUAN</label>
												</div>
												<div class="invalid-feedback">
											...
											<div class="form-group row">
												...
												<div class="form-check form-check-inline <?php echo form_error('alamat') ? 'is-invalid' : '' ?>">
													<input class="form-check-input" type="radio" name="is_kepala_keluarga" id="ya" value="1" <?php if ($penduduks->is_kepala_keluarga == '1') echo 'checked' ?>>
													<label class="form-check-label" for="ya">YA</label>
												</div>
												<div class="form-check form-check-inline">
													<input class="form-check-input" type="radio" name="is_kepala_keluarga" id="tidak" value="0" <?php if ($penduduks->is_kepala_keluarga == '0') echo 'checked' ?>>
											...
											<div class="form-group row">
												...
												<input class="col-sm-5 form-control <?php echo form_error('alamat') ? 'is-invalid' : '' ?>" type="text" id="alamat" name="alamat" placeholder="Alamat Jl./ Kampung..." value="<?php echo $penduduks->alamat ?>" />
											...
											<div class="form-group row">
												...
												<input class="col-sm-9 form-control <?php echo form_error('no_telp') ? 'is-invalid' : '' ?>" type="number" id="telp" name="no_telp" placeholder="Nomor Telepon/ Handphone" value="<?php echo $penduduks->no_telp ?>" />
												<div class="invalid-feedback">
											...
											<div class="form-group row">
												...
												<input class="col-form-control-file <?php echo form_error('image') ? 'is-invalid' : '' ?>" type="file" name="image" />
