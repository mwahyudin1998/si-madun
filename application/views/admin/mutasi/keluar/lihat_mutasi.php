  ...
  <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Detail Data Mutasi Penduduk Keluar</h1>
            </div>
            <div class="col-sm-6">
              ...
              <div class="card">
				...
				<div class="card mb-3">
					...
					<div class="card-body">
						...
						<button class="btn btn-success" onclick="window.location.href='<?php echo site_url('admin/mutasi/keluar/edit/'.$penduduks->nik) ?>'"><i class="fas fa-edit"></i> Ubah Data</button>
					</div>
