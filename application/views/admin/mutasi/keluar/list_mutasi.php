  ...
  <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-8">
              <h1>Mutasi Penduduk Keluar (Penduduk Pindah)</h1>
            </div>
            <div class="col-sm">
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <a href="<?php echo site_url('admin/mutasi/keluar/tambah') ?>"><i class="fas fa-plus"></i> Tambah Data Penduduk Keluar</a>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                      ...
                      <?php foreach ($penduduks as $penduduk): ?>
                        <tr  class="upper">
                          ...
                          <div class="d-flex flex-nowrap">
                            <a href="<?php echo site_url('admin/mutasi/keluar/edit/'.$penduduk->nik) ?>"
                              data-toggle="tooltip" title="Ubah Data Mutasi Penduduk Keluar"
                              class="btn btn-small"><i class="fas fa-edit"></i> </a>
                            <a href="<?php echo site_url('admin/mutasi/keluar/lihat/'.$penduduk->nik) ?>"
