              ...
              <div class="card">
				...
				<div class="card mb-3">
					<div class="card-header">
						<a href="<?php echo site_url('admin/penduduk') ?>"><i class="fas fa-arrow-left"></i> Kembali</a>
					</div>
					<div class="card-body">
						    ...
						    <div class="form-group row">
							   ...
							   <div class="col-sm-9">
							     <p class="col-form-label upper">: <?php echo $penduduks->alamat ?>
							     	...
							     	RW. <?php echo $penduduks->rw ?> SALEMBARAN JATI</p>
						...
						<button class="btn btn-success" onclick="window.location.href='<?php echo site_url('admin/penduduk/edit/'.$penduduks->nik) ?>'"><i class="fas fa-edit"></i> Ubah Data</button>
					</div>
