          ...
          <div class="card">
            <div class="page">
              ...
              <div class="isi">
                <center>
                  <u>
                    <h5><b>SURAT KETERANGAN PENGANTAR</b></h5>
                  </u>
                  ...
                  <div class="col">
                    <div class="col" style="padding-left: 20px;">
                      ...
                      <div class="row">
                        ...
                        <div class="col">
                          <h6>: <?= $surats->keterangan ?>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-4">
                          <h6>Berlaku Mulai Tanggal</h6>
                        </div>
                        <div class="col">
                          <h6>: <?php echo strftime("%d %B %Y"); ?> s/d
                            <?= strftime("%d %B %Y", mktime(0, 0, 0, date('n') + 1, date('j'), date('y'))); ?>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col">
                    <h6>Demikian Surat Keterangan Pengantar ini dibuat untuk dapat dipergunakan seperlunya. </h6>
                  </div>
                </div>
              </div><br><br><br>
              <div class="row">
