              ...
              <div class="card">
				...
				<div class="card mb-3">
					...
					<div class="card-body">
						...
						<form action="<?php echo site_url('admin/surat/domisili/tambah') ?>" method="post" enctype="multipart/form-data" >

							<div class="form-group row">
								<label class="col-sm-3 col-form-label" for="jeniss">Jenis Surat</label>
								<input style="cursor:not-allowed" readonly
								 class="col-sm-9 form-control"
								 type="text" id="jeniss" name="jenis_surat" value="SURAT KETERANGAN DOMISILI" />
							</div>
