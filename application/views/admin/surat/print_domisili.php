            ...
            <div class="page">
              ...
              <div class="isi">
                ...
                <div class="row">
                  <div class="col">
                    <h6>
                      Bahwa nama tersebut diatas adalah warga Desa Salembaran Jati Kecamatan Kosambi
                      Kabupaten Tangerang, dan menurut pengamatan RT dan RW setempat yang bersangkutan
                      benar-benar berdomisili pada alamat diatas.
                    </h6>
                  </div>
                </div><br>
                <div class="row">
                  <div class="col">
                    <h6>Demikian Surat Keterangan Domisili ini dibuat untuk dapat dipergunakan seperlunya. </h6>
                  </div>
                </div>
              </div><br><br><br><br><br>
              <div class="row">
