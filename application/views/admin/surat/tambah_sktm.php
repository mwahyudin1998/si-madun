              ...
              <div class="card">
				...
				<div class="card mb-3">
					<div class="card-header">
						<a href="<?php echo site_url('admin/surat/sktm') ?>"><i class="fas fa-arrow-left"></i> Kembali</a>
					</div>
					<div class="card-body">

						<form action="<?php echo site_url('admin/surat/sktm/tambah') ?>" method="post" enctype="multipart/form-data" >

							<div class="form-group row">
								<label class="col-sm-3 col-form-label" for="jeniss">Jenis Surat</label>
								<input style="cursor:not-allowed" readonly
								 class="col-sm-9 form-control"
								 type="text" id="jeniss" name="jenis_surat" value="SURAT KETERANGAN TIDAK MAMPU" />
							</div>
							...
							<input class="btn btn-success" type="submit" name="btn" value="Simpan" href="<?php echo site_url('admin/surat/sktm') ?>"/>
						</form>
