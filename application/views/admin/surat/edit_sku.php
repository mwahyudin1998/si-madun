									...
									<div class="card-body">
										...
										<form action="" method="post" enctype="multipart/form-data">
											...
											<div class="form-group row">
												...
												<textarea class="col-sm-9 form-control <?php echo form_error('keterangan') ? 'is-invalid' : '' ?>" type="text" id="keterangan" name="keterangan" placeholder="Isi sesuai nama usaha sesuai dengan usaha yang dilakukan" rows="3"><?php echo $surats->keterangan ?></textarea>
											</div>
