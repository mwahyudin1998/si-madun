          ...
          <div class="card">
            <div class="page">
              ...
              <div class="isi">
                  ...
                  <div class="col">
                    <div class="col" style="padding-left: 20px;">
                      <div class="row">
                        ...
                        <div class="col">
                          <h6>: <b>H. AGUS SETIAWAN, S.IP</b></h6>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-3">
                      ...
                      <div class="row">
                        ...
                        <div class="col">
                          <h6>: Jl. Salembaran Jati No.1 RT.01 / RW.01 Desa Salembaran Jati
                            <br> &nbsp; Kec. Kosambi Tangerang Banten 15214
                          </h6>
                        </div>
                      </div>
                ...
                <div class="row">
                  <div class="col">
                    <h6>Dengan ini menerangkan bahwa:
                    </h6>
                  </div>
                </div>
                <br>
                ...
                <div class="row">
                  <div class="col">
                    <h6>Bahwa orang tersebut adalah benar Penduduk Desa Salembaran Jati 
                    Kecamatan Kosambi Kabupaten Tangerang dan termasuk keluarga tidak mampu. 
                    Surat Ketrangan Tidak Mampu ini digunakan <b class="upper">"<?= $surats->keterangan ?>"</b></h6>
                  </div>
                </div><br>
                <div class="row">
                  <div class="col">
                    <h6>Demikian Surat Keterangan ini dibuat dengan sebenarnya untuk dapat dipergunakan
                    sebagaimana mestinya. </h6>
                  </div>
                </div>
              </div><br><br><br>
              <div class="row">
